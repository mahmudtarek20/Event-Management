		...
		<div class="container">
			<div class="w3layouts_breadcrumbs_left">
				<ul>
					...
					<li><i class="fa fa-info-circle" aria-hidden="true"></i>Entertainment</li>
				</ul>
			</div>
			...
			if ($result->num_rows) {
				...
				<div class="col-md-4">
					...
					<?php if (isset($_SESSION['username'])): ?>
						...
						$id=$row["id"];
						 $sql="SELECT * FROM orders WHERE service_id='$id' AND order_type='entertainment' AND username='$user' AND status=-1";
						$rst=mysqli_query($con, $sql);
						if ($rst->num_rows) { ?>
