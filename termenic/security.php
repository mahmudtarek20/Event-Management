...
<html lang="en">
<head>
<title>Security a Wedding Category Bootstrap Responsive Website Template | About :: w3layouts</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta charset="utf-8">
<meta name="keywords" content="Security Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<body>
			...
			<div class="container">
				<div class="header-left">
					<div class="w3layouts-logo">
						<h1 class="aac">
							<a href="security.php">Security Service</a>
						</h1>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="w3layouts_breadcrumbs_left">
				<ul>
					...
					<li><i class="fa fa-info-circle" aria-hidden="true"></i>Security Service</li>
				</ul>
			</div>
	...
	<div class="agile-ser">
		<div class="container">
			<?php $sql="SELECT * FROM security WHERE 1";
...
<!-- //services -->
	...
	<div class="footer">
			...
			<div class="w3agile_footer_grids">
				<div class="col-md-3 agileinfo_footer_grid">
					<div class="agileits_w3layouts_footer_logo">
						<h5><a href="index.php">Security</a></h5>
		...
		<div class="w3_agileits_footer_copy">
			<div class="container">
				<p>© 2017 Security. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a></p>
			</div>
		</div>
	</div>
	<!-- //footer -->
