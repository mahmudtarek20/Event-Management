			...
			<div class="container">
				<div class="header-left">
					<div class="w3layouts-logo">
						<h1 class="aac">
							<a href="decoration.php">Decor And Decoration</a>
						</h1>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="w3layouts_breadcrumbs_left">
				<ul>
					...
					<li><i class="fa fa-info-circle" aria-hidden="true"></i>Decoration</li>
				</ul>
			</div>
			...
			if ($result->num_rows) {
				...
				<div class="col-md-4">
					...
					<?php if (isset($_SESSION['username'])): ?>
						...
						$id=$row["id"];
						 $sql="SELECT * FROM orders WHERE service_id='$id' AND order_type='decoration' AND username='$user' AND status=-1";
						$rst=mysqli_query($con, $sql);
						if ($rst->num_rows) { ?>
...
<!-- //services -->
	...
	<div class="footer">
			...
			<div class="w3agile_footer_grids">
				<div class="col-md-3 agileinfo_footer_grid">
					<div class="agileits_w3layouts_footer_logo">
						<h5><a href="index.php">Decoration</a></h5>
		...
		<div class="w3_agileits_footer_copy">
			<div class="container">
				<p>© 2017 Decoration. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a></p>
			</div>
		</div>
	</div>
	<!-- //footer -->
